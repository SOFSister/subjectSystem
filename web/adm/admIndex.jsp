        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" id="edit-modal-body">
                    <form>
                        <div class="form-group">
                            <label for="edit_course_id">*课程编码</label>
                            <input id="edit_course_id" type="text" class="form-control" required autofocus oninput="value=value.replace(/[^\d]/g,'')">
                        </div>
                        <div class="form-group">
                            <label for="edit_course_name">*课程名称</label>
                            <input id="edit_course_name" type="text" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="edit_course_professional">适用专业</label>
                            <select class="form-control" id="edit_course_professional">
                                <option value="全部">全部</option>
                                <option value="计算机类">计算机类</option>
                                <option value="美术类">美术类</option>
                                <option value="数学类">数学类</option>
                        ...
                        <div class="form-group">
                            <label for="edit_course_term">*开设学期</label>
                            <input id="edit_course_term" type="text" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="edit_course_total">*课程人数</label>
                            <input id="edit_course_total" type="text" class="form-control" required oninput="value=value.replace(/[^\d]/g,'')">
                        </div>
                        <div class="form-group">
                            <label for="edit_course_kind">课程类型</label>
                            <select class="form-control" id="edit_course_kind">
                                <option value="全部">全部</option>
                                <option value="专业选修课">专业选修课</option>
                                <option value="公共任选课">公共任选课</option>
                                <option value="专业必修课">专业必修课</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="edit_course_info" rows="3"></textarea>
                        </div>
                        <hr>
                        <input type="button" id="edit_enter_btn" class="btn btn-primary btn-block" value="确定">
                    </form>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal -->
